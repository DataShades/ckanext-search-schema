...
## Releasing a new version of ckanext-search-schema

If ckanext-search-schema should be available on PyPI you can follow these steps to publish a new version:
